...
//		if (_pd > 5)
//	    {
//			show_debug_message("move_towards_point x+vx x=" + string(x) + ", x_goto=" + string(x_goto));
//			show_debug_message("move_towards_point x+vx y=" + string(y) + ", y_goto=" + string(y_goto));
//			show_debug_message("point_distance=" + string(_pd));
			
//			move_towards_point(x_goto, y_goto, 5);
//			_pd = point_distance(x, y, x_goto, y_goto);
//	    }
//		else {
//			show_debug_message("x+vx point reached, movement stopped.");
//			walkSpeed = 0;	
//			runSpeed = 0;
//		}
...
//		//	show_debug_message("move_towards_point y+vy y=" + string(y) + ", y_goto=" + string(y_goto));
//		//	move_towards_point(x_goto, y_goto, 5);
//	    //}
//		//else {
